...
function IconTrees({ size = 24 }: { size?: number }) {
  return (
    ...
    >
      ...
      <path d="M7 16v6" />
      <path d="M13 19v3" />
      <path d="M16 13v.2A3 3 0 0 1 14.9 19v0H11v0h0a3 3 0 0 1-1-5.8V13a3 3 0 0 1 6 0Z" />
    </svg>
  );
}
...
function IconDroplets({ size = 24 }: { size?: number }) {
  return (
    ...
    >
      ...
      <path d="M12.56 14.69c1.47 0 2.67-1.23 2.67-2.71 0-.78-.38-1.51-1.14-2.13-.76-.63-1.39-1.37-1.53-2.35-.14.98-.77 1.72-1.53 2.35-.76.62-1.14 1.35-1.14 2.13 0 1.48 1.2 2.71 2.67 2.71z" />
...
function IconGuitar({ size = 24 }: { size?: number }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="m20 7 1.7-1.7a1 1 0 0 0 0-1.4l-1.6-1.6a1 1 0 0 0-1.4 0L17 4" />
      <path d="m17 4-5.1 5.1" />
...
const galleryImages = [
  {
    ...
    alt: "Fachada del Salón de Fiestas Villaverde en Chalco estilo hacienda",
    className: "wide",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/interior.webp",
    alt: "Interior del salón Villaverde decorado para evento en Chalco",
    className: "",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/jardines.webp",
    alt: "Jardines con fuente del salón para bodas y XV años en Chalco",
    className: "tall",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/montaje.webp",
    alt: "Montaje de mesas elegantes para banquete en salón Villaverde",
    className: "",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/boda-decor.webp",
    alt: "Decoración elegante para boda en salón de fiestas Chalco",
    className: "",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/panoramica.webp",
    alt: "Vista panorámica del Salón de Fiestas Villaverde capacidad hasta 450 personas",
    className: "wide",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/pista-led.webp",
    alt: "Pista LED iluminada para XV años en salón Villaverde Chalco",
    className: "",
  },
  {
    src: "https://gfbixkddumsqlfrfbsmp.supabase.co/storage/v1/object/public/landing/escalera.webp",
    alt: "Escalera principal del salón para fotos de quinceañera en Chalco",
    className: "",
  },
];
    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className={`nav-links${menuOpen ? " open" : ""}`}>
          ...
          <a href="#extras" onClick={() => setMenuOpen(false)}>
            Extras
          </a>
          ...
          <a href="/eventus.html" onClick={() => setMenuOpen(false)}>
            Eventus
          </a>
          <a
            href="#formulario"
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            Salón de Fiestas todo incluido en Chalco · Bodas, XV Años y
            Graduaciones
          </p>
          <div className="hero-pills">
            <span className="hero-pill">
              <IconCheck size={14} /> Todo incluido
            </span>
            <span className="hero-pill">
              <IconCheck size={14} /> Desde $420/persona
            </span>
            <span className="hero-pill">
              <IconCheck size={14} /> Cortesías exclusivas
            </span>
          </div>
          ...
          <div className="events-grid">
            <a href="#paquetes" className="event-card">
              ...
              <div className="event-overlay">
                ...
                <span className="ev-btn">
                  Ver paquetes <IconChevronRight size={14} />
                </span>
              </div>
            </a>
            <a href="#paquetes" className="event-card">
            ...
            <div className="pkg pkg-premium reveal">
              ...
              <div className="pkg-body">
                ...
                <div className="pkg-feat">
                  ...
                  Cena formal de 3 tiempos (crema + plato fuerte + guarnición)
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                ...
                <div className="pkg-feat hi">
                  ...
                  Descorche libre — trae tus bebidas sin cargo
                </div>
                <div className="pkg-feat hi">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Botella ¾ por mesa incluida
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Mesas redondas + sillas Tiffany vestidas (colores básicos)
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Meseros con capitán + personal de recepción
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  DJ todo el evento + Maestro de Ceremonias
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Iluminación inteligente tipo antro
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                ...
                <div className="pkg-feat">
                  ...
                  2 camerinos privados (XV/novios + chambelanes)
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Invitación digital animada de regalo
                </div>
                <div className="pkg-cort">
                  <IconGift size={16} /> 1 cortesía a elegir de nuestra lista
                  exclusiva
                </div>
              </div>
              <a
                href="https://wa.me/529995485862?text=Hola%2C%20quiero%20apartar%20mi%20fecha%20con%20el%20Paquete%20PREMIUM"
                target="_blank"
                rel="noopener noreferrer"
                className="pkg-btn"
              >
            ...
            <div className="pkg pkg-diamante reveal">
              ...
              <div className="pkg-body">
                ...
                <div className="pkg-feat hi">
                  ...
                  Grupo versátil en vivo (5 integrantes)
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Cabina profesional para DJ con iluminación
                </div>
                <div className="pkg-feat hi">
                  <span className="ck">
                    <IconCheck size={10} />
                ...
                <div className="pkg-feat">
                  ...
                  Descargas de CO2 espectaculares
                </div>
                <div className="pkg-feat hi">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Chilaquiles de madrugada
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Colores de mantelería a elegir
                </div>
                <div className="pkg-cort">
                  <IconGift size={16} />
                  <IconGift size={16} /> 2 cortesías a elegir de nuestra lista
                  exclusiva
                </div>
              </div>
              <a
                href="https://wa.me/529995485862?text=Hola%2C%20quiero%20apartar%20mi%20fecha%20con%20el%20Paquete%20DIAMANTE"
                target="_blank"
                rel="noopener noreferrer"
                className="pkg-btn"
              >
            ...
            <div className="pkg pkg-esmeralda reveal">
              ...
              <div className="pkg-body">
                ...
                <div className="pkg-feat hi">
                  ...
                  Grupo versátil 9 integrantes
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Cabina foto 360 (1 hora)
                </div>
                <div className="pkg-feat hi">
                  <span className="ck">
                    <IconCheck size={10} />
                ...
                <div className="pkg-feat">
                  ...
                  Cantante durante la cena
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Cascada flores en escalera
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                  </span>{" "}
                  Inflable o trampolín
                </div>
                <div className="pkg-feat">
                  <span className="ck">
                    <IconCheck size={10} />
                ...
                <div className="pkg-cort">
                  <IconGift size={16} /> Paquete todo incluido
                </div>
              </div>
              <a
                href="https://wa.me/529995485862?text=Hola%2C%20quiero%20apartar%20mi%20fecha%20con%20el%20Paquete%20ESMERALDA"
                target="_blank"
                rel="noopener noreferrer"
                className="pkg-btn"
              >
            ...
            <table className="compare-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="compare-check">5 int.</td>
                  <td className="compare-check">9 int.</td>
                </tr>
                <tr>
                  <td>Pantalla LED</td>
                  <td className="compare-x">—</td>
                  <td className="compare-check">Incluida</td>
                  <td className="compare-check">Incluida</td>
                </tr>
                <tr>
                  <td>Show de robot</td>
                ...
                <tr>
                  ...
                  <td className="compare-x">—</td>
                  <td className="compare-x">—</td>
                  <td className="compare-check">1 hora</td>
                </tr>
                <tr>
                  <td>Chilaquiles</td>
                  <td className="compare-x">—</td>
                  <td className="compare-check">Incluidos</td>
                  <td className="compare-check">Incluidos</td>
                </tr>
                <tr>
                  <td>Cortesías</td>
        ...
        <div className="section-narrow">
          ...
          <div className="cort-explain reveal">
            <div className="cort-explain-item">
              <div className="ce-num" style={{ color: "var(--rosa)" }}>
                1
              </div>
            ...
            <div className="cort-explain-item">
              <div className="ce-num" style={{ color: "var(--gold)" }}>
                2
              </div>
              <div className="ce-label">
                cortesías a elegir
            ...
            <div className="cort-explain-item">
              <div className="ce-num" style={{ color: "var(--esmeralda)" }}>
                ∞
              </div>
              <div className="ce-label">
                todas incluidas
          ...
          <div className="cort-grid reveal">
            <div className="cort-item">
              <span className="ci">
                <IconFerrisWheel size={20} />
              </span>{" "}
              Inflable / trampolín en jardín
            </div>
            <div className="cort-item">
              <span className="ci">
                <IconLightbulb size={20} />
              </span>{" "}
              Iluminación LED en mesas
            </div>
            <div className="cort-item">
              <span className="ci">
                <IconMic size={20} />
            ...
            <div className="cort-item">
              ...
              Servicio de taxi dancer
            </div>
            <div className="cort-item">
              <span className="ci">
                <IconUtensils size={20} />
              </span>{" "}
              Torna fiesta de chilaquiles
            </div>
            <div className="cort-item">
              <span className="ci">
                <IconFlower size={20} />
            ...
            <div className="cort-item">
              <span className="ci">
                <IconPartyPopper size={20} />
              </span>{" "}
              Cabezones bailarines
            </div>
            <div className="cort-item">
              <span className="ci">
                <IconDroplets size={20} />
              </span>{" "}
              Máquina de burbujas
            </div>
            <div className="cort-item">
              ...
              <div className="tour360-frame">
                {tourOpen ? (
                  ...
                  >
                    ...
                    <span className="tour360-hint">
                      Muévete por el salón como si estuvieras aquí
                    </span>
                  </button>
                )}
              </div>
        ...
        >
          ...
          <button
            ...
            onClick={(e) => {
              e.stopPropagation();
              setLightboxIdx(
                (lightboxIdx - 1 + galleryImages.length) % galleryImages.length,
              );
            }}
            aria-label="Anterior"
          >
        ...
        <div className="section-narrow">
          ...
          <div className="why-grid reveal">
            <div className="why-card">
              ...
              <p>
                Arquitectura estilo hacienda que crea el escenario perfecto para
                tus fotos. Un lugar que tus invitados nunca olvidarán.
              </p>
            </div>
            <div className="why-card">
              <div className="why-icon">
              ...
              <p>
                Espacios exteriores hermosos para la recepción y sesión de fotos
                al atardecer.
              </p>
            </div>
            <div className="why-card">
            ...
            <div className="why-card">
              ...
              <p>
                Animada con cuenta regresiva, mapa de ubicación y confirmación
                por WhatsApp. Incluida en todos los paquetes.
              </p>
            </div>
            <div className="why-card">
              <div className="why-icon">
              ...
              <p>
                Todo incluido desde el primer momento. Nada de &quot;extras
                ocultos&quot; que inflan la cuenta al final.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section-narrow">
          ...
          {activeMenu === "entradas" && (
            <div
              ...
              role="tabpanel"
              id="menu-panel-entradas"
              aria-labelledby="menu-tab-entradas"
            >
              <h3>Entradas</h3>
              <div className="menu-items">
                {["Coctel de frutas", "Volovanes", "Ensaladas", "Melón"].map(
                  (item) => (
          ...
          {activeMenu === "cremas" && (
            <div
              className="menu-content active"
              role="tabpanel"
              id="menu-panel-cremas"
              aria-labelledby="menu-tab-cremas"
            >
              <h3>Cremas</h3>
              <div className="menu-items">
                {["Elote", "Nuez", "Champiñones", "Chile poblano"].map(
                  (item) => (
                    <span key={item} className="menu-item">
                      {item}
                    </span>
          ...
          {activeMenu === "pasta" && (
            <div
              ...
              role="tabpanel"
              id="menu-panel-pasta"
              aria-labelledby="menu-tab-pasta"
            >
              <h3>Pasta</h3>
          ...
          {activeMenu === "pollo" && (
            <div
              ...
              role="tabpanel"
              id="menu-panel-pollo"
              aria-labelledby="menu-tab-pollo"
            >
              <h3>Pollo</h3>
              <div className="menu-items">
                {["Almendrado", "A la naranja", "Adobado", "Cordon Blue"].map(
                  (item) => (
                    <span key={item} className="menu-item">
                      {item}
                    </span>
          ...
          {activeMenu === "cerdo" && (
            <div
              ...
              role="tabpanel"
              id="menu-panel-cerdo"
              aria-labelledby="menu-tab-cerdo"
            >
              <h3>Cerdito</h3>
              <div className="menu-subsection">
                <h4>Lomo:</h4>
                <div className="menu-items">
                  {["Enchilado", "Envinado", "A los tres chiles"].map(
                    (item) => (
                      <span key={item} className="menu-item">
                        {item}
                      </span>
          ...
          {activeMenu === "guarn" && (
            <div
              ...
              role="tabpanel"
              id="menu-panel-guarn"
              aria-labelledby="menu-tab-guarn"
            >
              <h3>Guarniciones</h3>
              <div className="menu-subsection">
                <div className="menu-items">
          ...
          <p className="menu-note reveal">
            Las verduras se sirven según la temporada del año.
          </p>
        </div>
      </section>
      ...
      <section className="section" id="extras">
        <div className="section-narrow">
          ...
          <div className="extras-grid reveal">
            {[
              ...
              },
              {
                ...
                name: "Video Remembranza",
                price: "$600",
              },
              {
                icon: <IconChurch size={28} />,
              ...
              <div key={extra.name} className="extra-card">
                ...
                {extra.detail && (
                  <div className="extra-detail">{extra.detail}</div>
                )}
              </div>
            ))}
          </div>
          <div className="extras-subtitle reveal">
            <IconMusic size={24} /> Música en Vivo
          </div>
          <div className="extras-grid reveal">
            {[
              {
              ...
              {
                icon: <IconDrum size={28} />,
                name: "Banda 13 int.",
                price: "$13,000",
              },
              {
                icon: <IconGuitar size={28} />,
                name: "Grupo 5 int.",
                price: "$13,000",
              },
              {
          ...
          <div className="extra-coctel reveal">
            <h3>
              <IconWine size={24} /> Fiesta Cóctel
            </h3>
      ...
      <section className="section bg-gris">
        <div className="section-narrow">
          ...
          {/* Testimonio REAL en video (14s, grabado en el salón la noche de la fiesta).
          ...
          <div className="testi-video reveal">
            ...
            <div className="testi-video-caption">
              ...
              <p>
                Una de nuestras quinceañeras, contándolo con sus palabras la
                misma noche de su fiesta. Sin guion y sin edición.
              </p>
              <div className="testi-event">XV Años · agosto 2026</div>
            </div>
          </div>
      ...
      <section className="section">
        <div className="section-narrow">
          ...
          >
            <IconMapPin size={16} /> Carretera México-Cuautla, Km. 35.5, Col.
            Santa Cruz Amalinalco, Chalco, Edo. de México
          </p>
      ...
      <section className="section bg-crema" id="faq">
        <div className="section-narrow">
          ...
          <p className="section-sub reveal">
            Todo lo que necesitas saber sobre tu evento en Villaverde
          </p>
          <div className="faq-list reveal">
            <details className="faq-item">
              <summary className="faq-question">
                ¿Cuánto cuesta un salón de fiestas en Chalco?
              </summary>
              <div className="faq-answer">
                En Salón de Fiestas Villaverde nuestros paquetes todo incluido
                van desde <strong>$420 por persona</strong> (Paquete Premium con
                150+ invitados) hasta <strong>$680 por persona</strong> (Paquete
                Esmeralda). Todos incluyen cena formal, descorche libre, DJ,
                iluminación inteligente, meseros y más. Sin costos ocultos.
              </div>
            </details>
            <details className="faq-item">
              <summary className="faq-question">
                ¿Qué incluye un paquete todo incluido para XV años?
              </summary>
              <div className="faq-answer">
                ...
                LED gigante y más espectáculos.
              </div>
            </details>
            <details className="faq-item">
              <summary className="faq-question">
            ...
            <details className="faq-item">
              <summary className="faq-question">
                ¿El salón Villaverde permite descorche libre?
              </summary>
              <div className="faq-answer">
                Sí,{" "}
                <strong>
                  todos nuestros paquetes incluyen descorche libre
                </strong>
            ...
            <details className="faq-item">
              <summary className="faq-question">
                ¿Cuántos invitados caben en el salón?
              </summary>
              <div className="faq-answer">
            ...
            <details className="faq-item">
              <summary className="faq-question">
                ¿Dónde se encuentra el Salón de Fiestas Villaverde?
              </summary>
              <div className="faq-answer">
                Estamos en{" "}
                <strong>
                  Carretera México-Cuautla, Km. 35.5, Col. Santa Cruz
                  Amalinalco, Chalco, Estado de México
                </strong>
                . Puedes agendar una visita sin compromiso para conocer nuestras
                instalaciones.
              </div>
            </details>
            <details className="faq-item">
              <summary className="faq-question">
                ¿Qué diferencia hay entre los paquetes Premium, Diamante y
                Esmeralda?
              </summary>
              <div className="faq-answer">
            ...
            <details className="faq-item">
              <summary className="faq-question">
                ¿Puedo agendar una visita para conocer el salón?
              </summary>
              <div className="faq-answer">
                Por supuesto. Las visitas son con cita previa. Puedes agendar
                por WhatsApp al <strong>9995485862</strong> y te mostraremos las
                instalaciones completas: salón, jardines, camerinos, cocina y
                todo lo que incluyen nuestros paquetes. Las fotos no le hacen
                justicia, te invitamos a conocernos en persona.
              </div>
            </details>
          </div>
        </div>
      ...
      <section className="section" id="formulario">
        <div className="section-narrow">
          <div className="wa-conversion reveal">
            <div className="wa-conversion-copy">
              <span className="wa-conversion-kicker">Respuesta inmediata</span>
              <h2>Tu cotización empieza con un mensaje</h2>
              <p>
                Abre WhatsApp y nuestro asistente te ayuda a revisar paquetes,
                disponibilidad y opciones para tu evento.
              </p>
              <ul
                className="wa-conversion-points"
                aria-label="Lo que puedes consultar"
              >
                <li>
                  <IconCheck size={15} /> Precios según tus invitados
                </li>
                <li>
                  <IconCheck size={15} /> Disponibilidad de tu fecha
                </li>
                <li>
                  <IconCheck size={15} /> Visita al salón sin compromiso
                </li>
              </ul>
            </div>
            <div className="wa-conversion-action">
              <a
                href={whatsappQuoteUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="btn-wa-big"
                onClick={() => trackWhatsAppClick("landing_cotizacion")}
              >
                <WhatsAppIcon size={24} /> Cotizar por WhatsApp
              </a>
              <span>Sin formularios · conversación privada</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-final" id="contacto">
        <div className="inner">
          ...
          <p className="cta-sub">
            Las fechas de fin de semana se agotan rápido — agenda tu visita sin
            compromiso.
          </p>
          ...
          >
            ...
            >
              <IconMapPin size={14} /> Chalco, Estado de México
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-social">
              ...
              <a
                href="https://www.facebook.com/SalonVillaVerde/"
                target="_blank"
                rel="noopener noreferrer"
                title="Facebook"
                aria-label="Facebook"
